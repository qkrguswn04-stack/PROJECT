...
SAVE_BASE = "/home/ubuntu/project/AI-HUB_preprocess/runs/classification_densenet_swin_3class_seed10_malignant"
os.makedirs(SAVE_BASE, exist_ok=True)

CLASS_NAMES = ["clear_cell", "endometrioid", "mucinous", "serous", "etc"]
...
# Benign Only
df = df[df['malignancy'] == 'malignant'].reset_index(drop=True)
...
n_train = len(train_df[train_df['label'].values == 2])
n_val = len(val_df[val_df['label'].values == 2])
...
def evaluate(model, loader, criterion):
    ...
    return {
        ...
        'f1_clear_cell' : report['clear_cell']['f1-score'],
