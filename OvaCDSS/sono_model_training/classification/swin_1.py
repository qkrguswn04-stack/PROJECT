...
SAVE_BASE = "/home/ubuntu/project/AI-HUB_preprocess/runs/classification_swin_3class_seed5"
...
print(" Swin Transformer 모댈 로드 중...")
...
print(f"\n Swin Transformer 3클래스 학습 시작 (seed={SEED})...")
print("=" * 50)
...
print("\n" + "=" * 50)
print(f"Swin Transformer 3클래스 학습 완료! (seed={SEED})")
