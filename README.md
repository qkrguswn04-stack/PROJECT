...
**Python, JavaScript, SQL**을 활용해 의료 데이터 분석과 인과 추론 기반의 임상 의사결정 지원 시스템을 구축한 **박현주**의 포트폴리오입니다. 데이터 접근 방식의 중요성, 인과 추론을 통한 통계 분석, 초음파 AI 이미지 분석까지 전 과정을 다룬 3개 프로젝트를 담았습니다.
